...
var XDGDataPaths = preload("res://src/scripts/animation/XDGDataPaths.gd")
...
var can_draw := false
var has_focus := false
var cursor_image = preload("res://assets/img/misc/cursor/cursor.png")
...
func notification_label(text : String) -> void:
	var notification : Label = load("res://src/scenes/animation/ui/NotificationLabel.tscn").instance()
